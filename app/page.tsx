      ...
      <div className="p-8">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="shadow-card hover:shadow-premium rounded-xl border border-gray-200 bg-white p-6 transition-all duration-300">
            ...
            <p className="mt-2 text-gray-600">
              Organized product categories with modern, intuitive navigation.
              Quick access to all your items.
            </p>
          </div>
          ...
          <div className="shadow-card hover:shadow-premium rounded-xl border border-gray-200 bg-white p-6 transition-all duration-300">
            ...
            <p className="mt-2 text-gray-600">
              Flexible addon system for product customization. Easy selection
              with modern UI controls.
            </p>
          </div>
          ...
          <div className="shadow-card hover:shadow-premium rounded-xl border border-gray-200 bg-white p-6 transition-all duration-300">
            ...
            <p className="mt-2 text-gray-600">
              Simple configuration and customization. Get started quickly with
              intuitive controls.
            </p>
          </div>
        </div>
        ...
        <div className="shadow-card mt-12 rounded-xl border border-gray-200 bg-white p-8">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            <div>
              <h3 className="font-semibold text-gray-900">Modern Aesthetics</h3>
              <p className="mt-2 text-gray-600">
